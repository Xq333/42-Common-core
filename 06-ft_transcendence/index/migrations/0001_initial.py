    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='offline', max_length=50, null=True)),
                ('last_seen', models.DateTimeField(blank=True, null=True)),
                ('avatar', models.ImageField(default='avatars/default.jpeg', upload_to='avatars/')),
                ('pseudo', models.CharField(default='Undefined by me', max_length=128, unique=True, verbose_name='pseudo')),
                ('email', models.EmailField(default='Ihavenoemail@gmail.com', max_length=254, unique=True, verbose_name='email address')),
                ...
                ('match_history', models.ManyToManyField(blank=True, related_name='users', to='index.match')),
